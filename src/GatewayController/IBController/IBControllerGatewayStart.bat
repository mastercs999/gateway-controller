...
set IBC_INI=to_be_replaced\IBController\IBController.ini
set TRADING_MODE=
set IBC_PATH=to_be_replaced\IBController
set TWS_PATH=%SYSTEMDRIVE%\Jts
set LOG_PATH=to_be_replaced\IBController\Logs
set TWSUSERID=username
set TWSPASSWORD=password
set FIXUSERID=
set FIXPASSWORD=
set JAVA_PATH=
set HIDE=
